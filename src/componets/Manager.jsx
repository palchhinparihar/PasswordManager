...
const Manager = () => {
  ...
  return (
    <>
      ...
      <section className="min-h-[81.8vh] md:min-h-[90.3vh] lg:min-h-[83.5vh]">
        ...
        <div className="container w-[80%] mx-auto flex flex-col justify-center px-5 pb-3">
          ...
          <div data-aos="fade-down" className="flex flex-col gap-5 w-full items-center">
          ...
          <div data-aos="fade-up" className="passwords">
